...
<br>The second model can predict whether an employee will leave the company using the same input features as for the first model (job satisfaction prediction) including job satisfaction rate.
<br>Project contains data analysis, model creation, testing and validation.
<br>Conclusions are made in the end.
